 ...
 * Return: This allocated string containg history file
 */
...
/**
 * read_history - This is reads history from file
 * @info: This is the parameter struct
 *
...
/**
 * renumber_history - This is the renumbers the history linked list after changes
